...
function Y_upstream = us_capital_linear_1o_simulation(inflows,C,ds_outflow,time_step,N)
n = length(inflows);
...
save('Simulation/us_capital_linear_1o_simulation/us_capital_linear_1o_simulation_data.mat');

% Simulate System
simu_file = 'us_capital_linear_1o_simulation_simu';
simIn = Simulink.SimulationInput(simu_file);
simIn = loadVariablesFromMATFile(simIn,"us_capital_linear_1o_simulation_data.mat");
warning('off');
out = sim(simIn);
clc;
