%%% Given the IDZ models associated to all the upstream conduits and the
%%% interceptor, the downstream operating depths, and the orifice
%%% parameters. We construct the final ID continuous time state-space model.

%%% A = {A_i}, B = {B_i}, E = E

function [A0,B0,A,B,E,xdelay,udelay,exoflow] = construct_ID_ct_system(equiv_conduits,interceptor,YX,orifice)
%% Import Parameters
CSO_counter = 1;
OR_counter = 1;
